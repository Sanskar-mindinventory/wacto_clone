...
from Users.views import AllSubscriptionView, CreateUserView, EmailVerificationView, SubscriptionView, UserView, CheckEmailAvailabilityView, ResetPasswordView, ResetPasswordConfirmView, ChangePasswordView
